...
<div style="background-color: white;" class="top-title">
            ...
            <hr>
            <div style="margin-left: 1%;" class="d-flex align-items-center flex-wrap mr-2">

<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Article day</h5>
...
<div style="padding-bottom: 1%;" class="col-md-3">
...
<select name="section" id="select-section-all-p" class="form-control">
...
<div class="input-group input-group-sm input-group-solid">
<select name="d_sort"  id="select-departement-all-p" class="form-control">
...
<!-- <div class="mt-1 mb-1 ml-2 mr-2 bg-gray-200"></div> -->
...
<!-- <div class="mt-1 mb-1 ml-1 bg-gray-200"></div> -->
...
$date_day = date("Y/m/d");
$stmt_loop = $con->prepare("SELECT * FROM lblarticles where userid = '".$_SESSION['id']."' ");
$stmt_loop->execute();
...
if($count > 0){
            ?>
            <div class="information-box" style="background-color:white;margin-top:1%;margin-left:7px;width:350px;" >
                ...
                <div class="d-flex mb-2 align-items-cente">
                 ...
                 if($row['custom_field'] == 'urgent'){
                  echo  '<a style="color:white;" type="button" value="Urgent" class="btn btn-danger form-control"/>Urgent</a>';
                        ...
                        ?>
                        <a style="margin-top: 1%;color:white;" type="button" class="btn btn-info form-control"><?php echo $row['transfer_to']; ?></a>
                    </div>
