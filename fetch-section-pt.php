...
$rows_datetime = $stmt_datetime->fetchAll();
 foreach($rows_datetime as $row_datetime){
   ...
   if($publication_date == $date_now && $publication_time > $time_now && $row_datetime['section'] == $_POST['request'] || $publication_date > $date_now && $row_datetime['section'] == $_POST['request']){
...
?>
 ...
 <?php }elseif(isset($_POST['request']) && $_POST['request'] == 'Sort by section'){ ?>
 <div class="container">
             <div id="result" style="padding-left: 2%; padding-bottom:2%;" class="row"> 
...
$rows_datetime = $stmt_datetime->fetchAll();
 foreach($rows_datetime as $row_datetime){
   ...
   if($publication_date == $date_now && $publication_time > $time_now && $_POST['request'] == 'Sort by section' || $publication_date > $date_now && $_POST['request'] == 'Sort by section'){
