...
$do = isset($_GET['do']) ? $_GET['do'] : 'videos';
$pagetitle = "Home";
...
<div style="background-color:white;padding-left:1%;  margin-right: 1%; border:solid 1px ;font-weight: bold;" class="data-field">
            <h5 style="margin-left: 1%;color:black;font-weight:bold;" class="title-h3">Manage Video</h5>
            <!-- <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row">
                            <div class="col-md-11">
                                <label style="margin-top: 3%;" class="label-add-user">Title</label>
                                <input onfocus="this.placeholder=''" onblur="this.placeholder='Enter the title'" placeholder="Enter the title" type="text" class="form-control" value="" name="title">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-11">
                                <label style="margin-top: 3%;" class="label-add-user">Description</label>
                                <input onfocus="this.placeholder=''" onblur="this.placeholder='Enter the description'" placeholder="Enter the description" name="description" class="form-control"/>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-md-11">
                                <label style="margin-top: 3%;" class="label-add-user">Link of video</label>
                                <input onfocus="this.placeholder=''" onblur="this.placeholder='Enter link video'" placeholder="Enter link video" name="link" class="form-control"/>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-md-11">
                                <label style="margin-top: 3%;" class="label-add-user">Download main image</label>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-11">
                                <label style="margin-top: 3%;" class="label-add-user">Download pictures</label>
                            </div>
                            <div class="col-md-4">
                ...
                <input type="date" name="date" id="ContentPlaceHolder1_txtDate" class="form-control">
                        ...
                        <div class="col-md-6">
	                        <div class="form-group">				    
                                <label style="margin-top: 3%;" class="label-add-user">Transferer à*</label>
...
foreach($formerror as $error) {
    ...
    if(empty($formerror)){
        ...
        $stmt_insert = $con->prepare("INSERT INTO videos 
        (v_title,v_description,v_link,v_main_image,v_gallery,v_date,v_transfer)
        VALUES (:ztitle, :zdescription, :zlink, :zmain_image, :zgallery, :zdate, :ztransfer)");
